...
if __name__ == '__main__':
	...
	m = 0
	surfaces = [#'smooth_torus_rr25_csr10.surface.vtk', 'smooth_cylinder_r10_h25.surface.vtk',
			#'smooth_sphere_r10.surface.vtk', 'noisy_sphere_r10.surface.vtk',
			'noisy_torus_rr25_csr10.surface.vtk'  #,'noisy_cylinder_r10_h25.surface.vtk'
			]
	subfolds = [#'smooth_torus', 'smooth_cylinder', 'smooth_sphere', 'noisy_sphere',
			'noisy_torus'#, 'noisy_cylinder'
			]
