...
"""
A script running Mindboggle from as a command line, getting the curvatures from
...
Example run from Mindboggle Docker container:
cd /home/jovyan/work/test_surfaces_mindboggle_output_n9
python ../scripts/run_mindboggle_curvature_command_line.py
    ../vtk_test_surfaces/torus_rr25_csr10.surface.vtk 9 

Internally, this command line is produced and run:
/opt/vtk_cpp_tools/curvature/CurvatureMain -m 0 -n 2
    -i torus_rr25_csr10.surface.mindboggle_n2_kappa2.vtk
    -x torus_rr25_csr10.surface.mindboggle_n2_kappa1.vtk
    -g torus_rr25_csr10.surface.mindboggle_n2_gauss_curv.vtk
    -d torus_rr25_csr10.surface.mindboggle_n2_T2.txt
    $DOCK/vtk_test_surfaces/torus_rr25_csr10.surface.vtk
