...
* ``curvature_calculation.py`` script for membrane curvature calculation workflows
  used in (\ `Bäuerlein et al. 2017, Cell <https://www.cell.com/fulltext/S0092-8674(17>`_\ 30934-0))
  and (\ `Collado et al. 2019, Developmental Cell <https://www.cell.com/developmental-cell/fulltext/S1534-5807(19>`_\ 30865-2))
