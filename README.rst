...
#. 
   Then, estimate surface normals at each triangle center using the neighboring
   triangles:
...
#. 
   Finally, estimate principle directions and curvatures and calculate different
