...
project = 'PyCurv'
copyright = '2017, Maria Kalemanov, Antonio Martinez-Sanchez'
...
latex_documents = [
    (master_doc, 'PyCurv.tex', 'PyCurv Documentation',
     'Maria Kalemanov, Antonio Martinez-Sanchez', 'manual'),
]
...
man_pages = [
    (master_doc, 'PyCurv', 'PyCurv Documentation',
     [author], 1)
]
...
pdf_documents = [
    (master_doc, 'PyCurv', 'PyCurv', author),
]
