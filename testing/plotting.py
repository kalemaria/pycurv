...
def add_line_hist(values, num_bins, value_range=None, max_val=None,
    ...
    if freq is False:
        ...
        frequencies = counts / float(len(values))
        plt.plot(bincenters, frequencies, ls=ls, marker=marker, c=c,
...
def plot_errors(
        ...
        num_bins=20, value_range=(0, 1), max_val=1, freq=False, outfile=None):
